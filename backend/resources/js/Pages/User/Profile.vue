    ...
    <UserLayout>
        <div class="adminlte-page-header">
            <div>
                ...
                <p class="text-muted mb-0">Manage your account details, destination profile, and password.</p>
            </div>
            ...
            <div class="col-md-3">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <h3 class="profile-username text-center">{{ user.full_name || 'User' }}</h3>
                        <p class="text-muted text-center">Applicant Account</p>
                            ...
                            <div class="active tab-pane" id="profile-overview">
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" :src="imagePreview" alt="User image">
                                        <span class="username">
                                            <a href="#">{{ user.full_name || 'User' }}</a>
                                        </span>
                                        <span class="description">Account summary and application profile</span>
                                    </div>

                                    <p>
                                        This page keeps your existing profile update logic but now uses the AdminLTE profile layout.
                                        Use the settings tab for profile details and the security tab for password updates.
                                    </p>
                                </div>

        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item" :class="{ active: isExact('/dashboard/overseas') }">
                        <Link class="sidebar-link" href="/dashboard/overseas">
                            <i class="align-middle" data-feather="globe"></i> <span class="align-middle">Overseas</span>
                        </Link>
                    </li>
                </ul>
            </div>
